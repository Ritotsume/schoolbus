<div class="side-menu sidebar-inverse">
	<nav class="navbar navbar-default" role="navigation">
		<div class="side-menu-container">
			...
			<li class="panel panel-default dropdown
			<?= (isset($page) && !empty($page) && $view != 'cadastra' && $page != 'home' && $page != 'manage') ? 'active' : ''; ?>">
		...
		<li class="<?= (isset($page) && $page == 'manage') ? 'active' : ''; ?>">
			<a href="<?= HOME; ?>manage">
				<span class="icon fa fa-cogs"></span><span class="title">Manutenção do Sistema</span>
			</a>
		</li>
